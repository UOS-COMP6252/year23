...
\tikzset{
  annotated cuboid/.pic={
    ...
    (b) +(0,-5pt) coordinate (b1) edge ["\cubex "'] (b1 -| c)
    (b) +(-5pt,0) coordinate (b2) edge ["\cubey "] (b2 |- a)
...
\begin{tikzpicture}
  ...
  \pic [fill=blue, text=green!50!black, draw=green!25!black] at (5.5,-1.5) {zaza cuboid={width=6, height=10, depth=50, units=mm}};
  \pic [fill=green, text=green!50!black, draw=green!25!black] at (5,-2) {annotated cuboid={width=6, height=10, depth=15, units=mm}};
